...
class LinkedList:
    ...
    def delete(self, value):
        ...
        elif self.head.value == value: #edge case considering if head is equal to specified value
    ...
    # Space Complexity: O(1)
    def reverse(self):
        if self.head == None: #edge case considering empty list
            return None

        elif self.head.next == None: #edge case considering if list has 1 elem
            self.head.next = None
